...
<body>
    ...
    <div class="choose">
        ...
        <div class="personnage">
            ...
            <img id="13" src="../IMAGE_DIALOGUES/ARNAULD_Lucie.png" alt="">
            <img id="37" src="../IMAGE_DIALOGUES/BASSILEKIN_Frank.png" alt="">
            <img id="39" src="../IMAGE_DIALOGUES/Bassiratou.png" alt="">
            <img id="40" src="../IMAGE_DIALOGUES/Billy_Joe.png" alt="">
            <img id="29" src="../IMAGE_DIALOGUES/CAI_Christine.png" alt="">
            <img id="33" src="../IMAGE_DIALOGUES/CAO_Sylvie.png" alt="">
            <img id="35" src="../IMAGE_DIALOGUES/Chanel.png" alt="">
            <img id="19" src="../IMAGE_DIALOGUES/Charbel.png" alt="">
            <img id="5" src="../IMAGE_DIALOGUES/CHARTIER_Anne-Lou.png" alt="">
            <img id="6" src="../IMAGE_DIALOGUES/CHETOUANI_Oumaïma.png" alt="">
            <img id="24" src="../IMAGE_DIALOGUES/Christelle.png" alt="">
            <img id="16" src="../IMAGE_DIALOGUES/CLAVEL_Thomas.png" alt="">
            <img id="14" src="../IMAGE_DIALOGUES/DERUNES_Océane-2.png" alt="">
            <img id="2" src="../IMAGE_DIALOGUES/DIALLO_Ousmane_Mamadou.png" alt="">
            <img id="25" src="../IMAGE_DIALOGUES/DIAS_Thomas.png" alt="">
            <img id="17" src="../IMAGE_DIALOGUES/FEUILLERAT_Laurie.png" alt="">
            <img id="11" src="../IMAGE_DIALOGUES/Frani.png" alt="">
            <img id="28" src="../IMAGE_DIALOGUES/GONZALEZ_Sofia.png" alt="">
            <img id="20" src="../IMAGE_DIALOGUES/GRAVELINES_Thomas.png" alt="">
            <img id="38" src="../IMAGE_DIALOGUES/HAMADA_Tachrifa.png" alt="">
            <img id="15" src="../IMAGE_DIALOGUES/JOLIVET_Mendrika.png" alt="">
            <img id="26" src="../IMAGE_DIALOGUES/LAKHOUBAY_Inshya.png" alt="">
            <img id="27" src="../IMAGE_DIALOGUES/LEBAZ_Antoni.png" alt="">
            <img id="9" src="../IMAGE_DIALOGUES/LEGRAND_Florian.png" alt="">
            <img id="7" src="../IMAGE_DIALOGUES/Leroy_Etienne.png" alt="">
            <img id="32" src="../IMAGE_DIALOGUES/Malina.png" alt="">
            <img id="23" src="../IMAGE_DIALOGUES/MARTINEZ_Camille.png" alt="">
            <img id="10" src="../IMAGE_DIALOGUES/Michel_Chen.png" alt="">
            <img id="21" src="../IMAGE_DIALOGUES/Morjane.png" alt="">
            <img id="12" src="../IMAGE_DIALOGUES/MOUANDZA_Bernard_Yann_Ordian.png" alt="">
            <img id="1" src="../IMAGE_DIALOGUES/Ousmane.png" alt="">
            <img id="18" src="../IMAGE_DIALOGUES/PISPISA_Maxime.png" alt="">
            <img id="3" src="../IMAGE_DIALOGUES/RICHARD_Florent.png" alt="">
            <img id="30" src="../IMAGE_DIALOGUES/RISSE_Herve.png" alt="">
            <img id="22" src="../IMAGE_DIALOGUES/SAINT-PRIX_Savy.png" alt="">
            <img id="8" src="../IMAGE_DIALOGUES/SURMAIRE_Corentin.png" alt="">
            <img id="31" src="../IMAGE_DIALOGUES/TITUS_Britin.png" alt="">
            <img id="36" src="../IMAGE_DIALOGUES/VESPUCE_Jérémi.png" alt="">
            <img id="4" src="../IMAGE_DIALOGUES/Victoire.png" alt="">
    ...
    <script>
    let tariknom = document.getElementById('34');
    let lucienom = document.getElementById('13');
    let franknom = document.getElementById('37');
    let bassiratounom = document.getElementById('39');
    let billynom = document.getElementById('40');
    let christinenom = document.getElementById('29');
    let sylvienom = document.getElementById('33');
    let chanelnom = document.getElementById('35');
    let charbelnom = document.getElementById('19');
    let annenom = document.getElementById('5');
    let oumaimanom = document.getElementById('6');
    let christellenom = document.getElementById('24');
    let thomascnom = document.getElementById('16');
    let oceanenom = document.getElementById('14');
    let ousmanednom = document.getElementById('2');
    let thomasdnom = document.getElementById('25');
    let laurienom = document.getElementById('17');
    let franinom = document.getElementById('11');
    let sofianom = document.getElementById('28');
    let thomasgnom = document.getElementById('20');
    let tachrifanom = document.getElementById('38');
    let mendrikanom = document.getElementById('15');
    let inshyanom = document.getElementById('26');
    let antoninom = document.getElementById('27');
    let floriannom = document.getElementById('9');
    let etiennenom = document.getElementById('7');
    let malinanom = document.getElementById('32');
    let camillenom = document.getElementById('23');
    let michelnom = document.getElementById('10');
    let morjanenom = document.getElementById('21');
    let yannnom = document.getElementById('12');
    let ousmanesnom = document.getElementById('1');
    let maximenom = document.getElementById('18');
    let florentnom = document.getElementById('3');
    let hervenom = document.getElementById('30');
    let savynom = document.getElementById('22');
    let corentinnom = document.getElementById('8');
    let britninom = document.getElementById('31');
    let jeremienom = document.getElementById('36');
    let victoirenom = document.getElementById('4');
